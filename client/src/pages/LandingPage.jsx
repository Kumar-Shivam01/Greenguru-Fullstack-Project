      ...
      <section className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-b from-[#121E16] to-[#0A140E] border border-white/15 p-8 sm:p-14 text-center shadow-[0_30px_90px_rgba(0,0,0,0.8)]">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            {/* Quick 1-Click Social Auth */}
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Link
                to="/register"
                className="px-5 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/15 text-white text-xs font-semibold flex items-center gap-2.5 transition-all hover:scale-105"
              >
            ...
            <div className="mt-4 text-[11px] text-slate-400">
              No credit card required. Free tier includes up to 5 plant health scans per month.
            </div>
          </div>
        </div>
      </section>
